@extends('layouts.app') @section('title','Add coach') @section('content')
<div class="container mt-5">
    ...
    <div class="jumbotron bg-dark text-white animated rotateInUpLeft">

        <h1><i class="fa fa-user-plus" aria-hidden="true"></i> Add a coach</h1>
        <form id="add_coach" action="/manager/addcoach" method="POST">
            {!! csrf_field() !!}
